...
def main():
    ...
    examples = ["Dan was not born in Lisbon", "Dan was born in Lisbon"]
    examples = ["Lucent , based in Murray Hill , filed the lawsuit in federal court in Newark this month ."]
    for s in examples:
        print s
